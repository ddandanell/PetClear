...
const WhatsAppBtn = ({
  ...
  const href = `https://wa.me/9715XXXXXXXX?text=${encodeURIComponent(message)}`
  return (
    <a
      href={href}
      target="_blank"
      rel="noopener noreferrer"
      className={`inline-flex items-center gap-2 px-6 py-3.5 bg-[#25D366] text-white rounded-xl font-semibold text-sm hover:bg-[#1ebe57] transition-colors shadow-sm ${className}`}
    >
...
const SectionHeading = ({ children, className = '' }: { children: React.ReactNode; className?: string }) => (
  <h2 className={`text-2xl sm:text-3xl lg:text-4xl font-bold text-[#1A1A1A] tracking-tight ${className}`}>
    {children}
  </h2>
)

const SectionIntro = ({ children }: { children: React.ReactNode }) => (
  <p className="text-base sm:text-lg text-[#5C5C5C] leading-relaxed max-w-3xl">{children}</p>
)
  ...
  return (
    <div className="faq-item">
      <button onClick={() => setOpen(!open)} className="faq-question w-full text-left">
        ...
        {open ? <ChevronUp className="w-5 h-5 shrink-0 text-[#1A5F4A]" /> : <ChevronDown className="w-5 h-5 shrink-0 text-[#8A8A8A]" />}
      </button>
...
function Step({ number, title, children }: { number: number; title: string; children: React.ReactNode }) {
  return (
    <div className="relative pl-10 pb-10 last:pb-0">
      <div className="absolute left-0 top-0 w-7 h-7 rounded-full bg-[#1A5F4A] text-white flex items-center justify-center text-sm font-bold">
        {number}
      </div>
      <div className="absolute left-3.5 top-7 bottom-0 w-px bg-[#1A5F4A]/20" />
      <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">{title}</h3>
      <div className="text-[#5C5C5C] leading-relaxed space-y-2">{children}</div>
    </div>
  )
}
    ...
    <div className="bg-[#FAFBF7]">
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "Cat Relocation to Dubai", item: "https://www.petclear.ae/cat-relocation-to-dubai/" }
          ]
        })}
      </script>
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          author: { "@type": "Organization", name: "PetClear", url: "https://www.petclear.ae" },
          publisher: {
            "@type": "Organization",
            name: "PetClear",
            logo: { "@type": "ImageObject", url: "https://www.petclear.ae/assets/logo.png" }
          },
          datePublished: "2026-06-25",
          dateModified: "2026-06-25",
          mainEntityOfPage: { "@type": "WebPage", "@id": "https://www.petclear.ae/cat-relocation-to-dubai/" }
        })}
      </script>
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="order-2 lg:order-1">
              <div className="flex items-center gap-2 mb-4">
                <PawPrint className="w-5 h-5 text-[#1A5F4A]" />
                <span className="text-sm font-semibold text-[#1A5F4A] uppercase tracking-wide">Cat Relocation</span>
              </div>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1A1A1A] tracking-tight leading-tight mb-6">
                Cat Relocation to Dubai: Bringing Your Cat Home Safely
              </h1>
              <p className="text-lg sm:text-xl text-[#5C5C5C] leading-relaxed mb-6">
              ...
              <p className="text-base text-[#5C5C5C] leading-relaxed mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <Link
                  to="/how-it-works"
                  className="inline-flex items-center justify-center gap-2 px-6 py-3.5 border-2 border-[#1A5F4A] text-[#1A5F4A] rounded-xl font-semibold text-sm hover:bg-[#1A5F4A]/5 transition-colors"
                >
                  How it works
              ...
              <div className="flex flex-wrap items-center gap-4 text-xs text-[#8A8A8A]">
                <span className="flex items-center gap-1"><Award className="w-3.5 h-3.5 text-[#E8A838]" /> IPATA-certified</span>
                <span className="flex items-center gap-1"><Shield className="w-3.5 h-3.5 text-[#E8A838]" /> MOCCAE-licensed</span>
                <span className="flex items-center gap-1"><Globe className="w-3.5 h-3.5 text-[#E8A838]" /> IATA-compliant</span>
                <span className="flex items-center gap-1"><Heart className="w-3.5 h-3.5 text-[#E8A838]" /> 150+ cats relocated</span>
              </div>
            </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            {/* Card 1 */}
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 hover:shadow-md transition-shadow">
              <div className="w-10 h-10 rounded-xl bg-[#1A5F4A]/10 flex items-center justify-center mb-4">
                <PawPrint className="w-5 h-5 text-[#1A5F4A]" />
              </div>
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">&ldquo;My cat will be terrified the whole flight.&rdquo;</h3>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 hover:shadow-md transition-shadow">
              <div className="w-10 h-10 rounded-xl bg-[#E8A838]/10 flex items-center justify-center mb-4">
                <Droplets className="w-5 h-5 text-[#E8A838]" />
              </div>
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">&ldquo;My cat won't eat or drink during the journey.&rdquo;</h3>
              <p className="text-sm text-[#5C5C5C] leading-relaxed">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">&ldquo;What if my cat tries to escape from the crate?&rdquo;</h3>
              <p className="text-sm text-[#5C5C5C] leading-relaxed">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 hover:shadow-md transition-shadow sm:col-span-2 lg:col-span-3">
              <div className="w-10 h-10 rounded-xl bg-[#2D8B6F]/10 flex items-center justify-center mb-4">
                <Heart className="w-5 h-5 text-[#2D8B6F]" />
              </div>
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">&ldquo;What if something goes wrong?&rdquo;</h3>
              <p className="text-sm text-[#5C5C5C] leading-relaxed">
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 hover:shadow-md transition-shadow">
              <div className="w-10 h-10 rounded-full bg-[#1A5F4A] text-white flex items-center justify-center text-sm font-bold mb-4">1</div>
              <h3 className="text-base font-semibold text-[#1A1A1A] mb-2">MOCCAE Import Permit</h3>
              <p className="text-sm text-[#5C5C5C] leading-relaxed">A mandatory approval from the UAE Ministry of Climate Change and Environment. Cost: approximately AED 200. Valid: 30–90 days. We apply for this on your behalf.</p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 hover:shadow-md transition-shadow">
              <div className="w-10 h-10 rounded-full bg-[#1A5F4A] text-white flex items-center justify-center text-sm font-bold mb-4">2</div>
              <h3 className="text-base font-semibold text-[#1A1A1A] mb-2">ISO Microchip (15-Digit)</h3>
              <p className="text-sm text-[#5C5C5C] leading-relaxed">Your cat must have an ISO 11784/11785 compliant microchip. This must be implanted <em>before</em> the rabies vaccination, and the microchip number must appear on every certificate. This is the most common paperwork error — and it's easily avoided with a single checklist.</p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 hover:shadow-md transition-shadow">
              <div className="w-10 h-10 rounded-full bg-[#1A5F4A] text-white flex items-center justify-center text-sm font-bold mb-4">3</div>
              <h3 className="text-base font-semibold text-[#1A1A1A] mb-2">Rabies Vaccination</h3>
              <p className="text-sm text-[#5C5C5C] leading-relaxed">Administered at or after 12 weeks of age. The vaccination must be at least 21 days old before your cat travels, and within 12 months of arrival. Only inactivated or recombinant vaccines are accepted — not live attenuated vaccines.</p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 hover:shadow-md transition-shadow">
              <div className="w-10 h-10 rounded-full bg-[#1A5F4A] text-white flex items-center justify-center text-sm font-bold mb-4">4</div>
              <h3 className="text-base font-semibold text-[#1A1A1A] mb-2">FVRCP (Core Feline Vaccines)</h3>
              <p className="text-sm text-[#5C5C5C] leading-relaxed">Your cat needs up-to-date core vaccinations: Feline Panleukopenia (FPV), Feline Rhinotracheitis (FHV-1), and Feline Calicivirus (FCV). Feline Leukemia (FeLV) is also recommended by most veterinary authorities.</p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 hover:shadow-md transition-shadow">
              <div className="w-10 h-10 rounded-full bg-[#1A5F4A] text-white flex items-center justify-center text-sm font-bold mb-4">5</div>
              <h3 className="text-base font-semibold text-[#1A1A1A] mb-2">International Health Certificate</h3>
              <p className="text-sm text-[#5C5C5C] leading-relaxed">Issued by an official or government-accredited veterinarian in your country of origin. This must be issued within 10 days of arrival in Dubai. It must include antiparasitic treatment records and show the same microchip number as all other documents.</p>
            </div>
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 hover:shadow-md transition-shadow">
              <div className="w-10 h-10 rounded-full bg-[#1A5F4A] text-white flex items-center justify-center text-sm font-bold mb-4">6</div>
              <h3 className="text-base font-semibold text-[#1A1A1A] mb-2">Antiparasitic Treatment</h3>
              <p className="text-sm text-[#5C5C5C] leading-relaxed">Internal deworming (Praziquantel) and external treatment (Fipronil or equivalent) must be administered within 14 days of arrival. We coordinate this with our vet partner so the timing is exact.</p>
            </div>
          </div>

          <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 mt-6">
            <div className="w-10 h-10 rounded-full bg-[#E8A838] text-white flex items-center justify-center text-sm font-bold mb-4">7</div>
            <h3 className="text-base font-semibold text-[#1A1A1A] mb-2">Copy of Owner's Passport & UAE Visa</h3>
            <p className="text-sm text-[#5C5C5C] leading-relaxed">Required for the MOCCAE permit application and customs clearance. If you're not yet in Dubai, we can arrange for a representative to handle collection.</p>
          </div>

          <div className="mt-8 p-6 bg-[#F5F0E8] rounded-2xl">
            <p className="text-sm text-[#5C5C5C] leading-relaxed mb-3">
              <strong className="text-[#1A1A1A]">Good news for UK, EU, USA, Canada, Australia, and New Zealand owners:</strong> Your country is classified as low-risk for rabies. This means <strong className="text-[#1A1A1A]">no rabies titer test (RNATT) is required</strong>, and the minimum timeline is just 4–6 weeks from start to finish. For high-risk countries, a titer test is required with a 90-day waiting period — so the timeline extends to 4 months minimum.
            </p>
            <p className="text-sm text-[#5C5C5C] leading-relaxed">
              <strong className="text-[#1A1A1A]">Important:</strong> Cats must be at least 4 months old to enter Dubai. If your kitten is younger, you'll need to wait or arrange temporary care until they reach the minimum age.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mt-12">
            <div className="bg-[#F0FDF4] border border-[#BBF7D0] rounded-2xl p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-[#27AE60]">No domestic cat breeds are banned</h3>
              </div>
            ...
            <div className="warning-box">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-[#1A1A1A]">One important restriction: wild cat hybrids</h3>
              </div>
              <p className="text-sm text-[#5C5C5C] leading-relaxed mb-4">
                <strong className="text-[#1A1A1A]">Wild cat hybrids are not permitted unless they are 5th generation or further removed from the wild pedigree.</strong> This includes early-generation Savannah cats (F1–F4) and early-generation Bengal cats (F1–F4).
              </p>
              <p className="text-sm text-[#5C5C5C] leading-relaxed mb-4">
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mt-12">
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8">
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-4">IATA Standards for Cat Crates</h3>
              <p className="text-sm text-[#5C5C5C] mb-4">All cats entering Dubai must travel in an IATA-compliant crate. This means:</p>
              <ul className="space-y-3 text-sm text-[#5C5C5C]">
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">Rigid construction:</strong> Hard plastic or plywood with a solid roof and floor. No soft-sided carriers for cargo.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">Secure door:</strong> Metal door with a locking mechanism that cannot be opened from the inside. The door must close firmly without gaps.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">Ventilation:</strong> Openings on all four sides, covering at least 16% of the total surface area. For brachycephalic (flat-faced) cats like Persians or Exotic Shorthairs, the crate must be 10% larger than standard with increased ventilation.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">No wheels:</strong> Wheels must be removed or locked.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">Leak-proof floor:</strong> A solid, absorbent base that won't let moisture escape.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">No top-opening lids:</strong> Cargo crates must open from the front only.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">Proper sizing:</strong> Your cat must be able to stand upright without touching the roof, turn around easily, and lie down in a natural position. We measure your cat precisely.</span>
                </li>
              </ul>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8">
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-4">Making the Crate Feel Like Home</h3>
              <p className="text-sm text-[#5C5C5C] mb-4">A few simple additions make a big difference for cats:</p>
              <ul className="space-y-3 text-sm text-[#5C5C5C]">
                <li className="flex items-start gap-2">
                  <Heart className="w-4 h-4 text-[#E8A838] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">A small, familiar blanket or item of your clothing:</strong> Your scent is comforting.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">Absorbent bedding:</strong> A thin layer that won't bunch up. We provide vet-approved absorbent pads.</span>
                </li>
                <li className="flex items-start gap-2">
                  <Droplets className="w-4 h-4 text-[#2D8B6F] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">Spill-proof water container:</strong> Attached to the door, filled at check-in. We freeze water in the container for long flights so it melts gradually.</span>
                </li>
                <li className="flex items-start gap-2">
                  <Coffee className="w-4 h-4 text-[#E8A838] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">Food tray:</strong> Attached to the inside of the door with a small portion of dry food. We include written feeding instructions.</span>
                </li>
              </ul>
            </div>
            <div className="bg-[#F5F0E8] rounded-2xl p-6 sm:p-8">
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-4">What About a Litter Box?</h3>
              <p className="text-sm text-[#5C5C5C] leading-relaxed">
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mt-12">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-4">
                <Plane className="w-6 h-6 text-[#1A5F4A]" />
                <h3 className="text-lg font-semibold text-[#1A1A1A]">Emirates SkyCargo (Most Common Route to Dubai)</h3>
              </div>
              <p className="text-sm text-[#5C5C5C] mb-4">Emirates is the primary carrier for cats arriving at Dubai International (DXB). Here's what you need to know:</p>
              <ul className="space-y-2 text-sm text-[#5C5C5C]">
                <li className="flex items-start gap-2"><span className="text-[#C0392B] font-bold">✕</span> <strong className="text-[#1A1A1A]">No cabin or checked baggage:</strong> All cats must travel via Emirates SkyCargo.</li>
                <li className="flex items-start gap-2"><span className="text-[#27AE60] font-bold">✓</span> <strong className="text-[#1A1A1A]">Advance booking:</strong> Minimum 72 hours notice required. We handle this.</li>
                <li className="flex items-start gap-2"><span className="text-[#27AE60] font-bold">✓</span> <strong className="text-[#1A1A1A]">Documentation:</strong> We submit your cat's health certificate, crate photos, and the Owner Acknowledgement Form on your behalf.</li>
                <li className="flex items-start gap-2"><span className="text-[#27AE60] font-bold">✓</span> <strong className="text-[#1A1A1A]">Transit care:</strong> If your cat is in transit in Dubai for more than 6 hours, they're cared for at the Emirates Pet Lounge — a climate-controlled facility with trained staff.</li>
                <li className="flex items-start gap-2"><span className="text-[#E8A838] font-bold">!</span> <strong className="text-[#1A1A1A]">Cost:</strong> Typically ranges from USD 1,500–5,000 depending on your origin country, route, and your cat's weight/crate size.</li>
                <li className="flex items-start gap-2"><span className="text-[#E8A838] font-bold">!</span> <strong className="text-[#1A1A1A]">Breed restrictions:</strong> Emirates follows UAE federal rules. No domestic cat breeds are banned, but brachycephalic cats may have seasonal restrictions (November–April only) due to heat sensitivity.</li>
              </ul>
            </div>

            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-4">
                <Plane className="w-6 h-6 text-[#E8A838]" />
                <h3 className="text-lg font-semibold text-[#1A1A1A]">Etihad Airways (Abu Dhabi Only — With In-Cabin Option)</h3>
              </div>
              <p className="text-sm text-[#5C5C5C] mb-4">Etihad is the most pet-friendly UAE airline, but with an important limitation: their in-cabin option is only for flights to Abu Dhabi (AUH), not Dubai.</p>
              <ul className="space-y-2 text-sm text-[#5C5C5C]">
                <li className="flex items-start gap-2"><span className="text-[#27AE60] font-bold">✓</span> <strong className="text-[#1A1A1A]">In-cabin (PETC):</strong> Small cats (pet + carrier ≤ 8 kg) can travel in the cabin on flights to Abu Dhabi. Carrier max size: 40 x 40 x 22 cm in Economy. Fee: USD 399 per flight segment.</li>
                <li className="flex items-start gap-2"><span className="text-[#27AE60] font-bold">✓</span> <strong className="text-[#1A1A1A]">Cargo:</strong> Larger cats or those flying to Abu Dhabi via cargo.</li>
                <li className="flex items-start gap-2"><span className="text-[#E8A838] font-bold">!</span> <strong className="text-[#1A1A1A]">Important:</strong> If you fly into Abu Dhabi, you'll need to arrange ground transport to Dubai (about 90 minutes). We can coordinate this for you.</li>
              </ul>
            </div>
          </div>

          <div className="mt-8 bg-[#F5F0E8] rounded-2xl p-6 sm:p-8">
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-4">flydubai & Other Carriers</h3>
            <p className="text-sm text-[#5C5C5C] leading-relaxed">
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 bg-[#FEF2F2] border border-[#FECACA] rounded-2xl p-6 sm:p-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-8">
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8">
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-4">What We Recommend Instead</h3>
              <p className="text-sm text-[#5C5C5C] mb-4">A calm cat is a prepared cat. We help you reduce travel stress without medication:</p>
              <ul className="space-y-3 text-sm text-[#5C5C5C]">
                <li className="flex items-start gap-2">
                  <Home className="w-4 h-4 text-[#1A5F4A] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">Crate familiarity:</strong> Start crate training 2–3 weeks before travel. Feed your cat in the crate. Let them nap in it. Make it a safe space, not a signal that something scary is happening.</span>
                </li>
                <li className="flex items-start gap-2">
                  <Droplets className="w-4 h-4 text-[#2D8B6F] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">Feliway or calming pheromones:</strong> We recommend spraying the crate interior with a feline pheromone spray 30 minutes before departure. This is non-medicinal and widely used by vets.</span>
                </li>
                <li className="flex items-start gap-2">
                  <Moon className="w-4 h-4 text-[#E8A838] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">Timing:</strong> We book morning flights. Cats are naturally more active at dawn and dusk; a morning departure aligns with their rhythm.</span>
                </li>
                <li className="flex items-start gap-2">
                  <Plane className="w-4 h-4 text-[#1A5F4A] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">Direct routing:</strong> We avoid unnecessary connections. The fewer transitions, the less stress.</span>
                </li>
                <li className="flex items-start gap-2">
                  <Coffee className="w-4 h-4 text-[#E8A838] shrink-0 mt-0.5" />
                  <span><strong className="text-[#1A1A1A]">Hunger, not fasting:</strong> We do not recommend fasting cats before travel. A small meal 4–6 hours before departure is fine. Water should be available until check-in.</span>
                </li>
              </ul>
            </div>
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8">
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-4">When Medication Might Be Appropriate</h3>
              <p className="text-sm text-[#5C5C5C] leading-relaxed mb-4">
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mt-12">
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-4">
                <Thermometer className="w-6 h-6 text-[#E8A838]" />
                <h3 className="text-lg font-semibold text-[#1A1A1A]">Summer Heat Embargo (June–September)</h3>
              </div>
              <p className="text-sm text-[#5C5C5C] leading-relaxed mb-4">
              ...
              <ul className="list-disc pl-5 text-sm text-[#5C5C5C] space-y-2 mb-4">
                <li><strong className="text-[#1A1A1A]">June–August:</strong> Very limited cargo options. Some routes are suspended entirely.</li>
                <li><strong className="text-[#1A1A1A]">May and September:</strong> Restricted — some routes available, some not.</li>
                <li><strong className="text-[#1A1A1A]">October–April:</strong> Normal operations.</li>
              </ul>
              <p className="text-sm font-semibold text-[#1A1A1A] mb-2">What this means for your cat:</p>
              <p className="text-sm text-[#5C5C5C] leading-relaxed mb-4">
                If your move falls during summer, you have options. We can arrange:
              </p>
              <ul className="list-disc pl-5 text-sm text-[#5C5C5C] space-y-1 mb-4">
            ...
            <div className="bg-[#F5F0E8] rounded-2xl p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-4">
                <Heart className="w-6 h-6 text-[#1A5F4A]" />
                <h3 className="text-lg font-semibold text-[#1A1A1A]">Long-Haired and Flat-Faced Cats</h3>
              </div>
              <p className="text-sm text-[#5C5C5C] leading-relaxed mb-4">
              ...
              <ul className="list-disc pl-5 text-sm text-[#5C5C5C] space-y-2 mb-4">
                <li><strong className="text-[#1A1A1A]">Flight times</strong> (morning departures only)</li>
                <li><strong className="text-[#1A1A1A]">Crate ventilation</strong> (increased airflow for brachycephalic cats)</li>
                <li><strong className="text-[#1A1A1A]">Route selection</strong> (direct flights, minimal ground time)</li>
                <li><strong className="text-[#1A1A1A]">Seasonal timing</strong> (if possible, we recommend October–April for these breeds)</li>
              </ul>
              <p className="text-sm text-[#5C5C5C] leading-relaxed">
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 overflow-x-auto">
            <table className="data-table">
              ...
              <tbody>
                <tr>
                  <td className="font-semibold text-[#1A1A1A]">UK to Dubai</td>
                ...
                <tr>
                  <td className="font-semibold text-[#1A1A1A]">USA to Dubai</td>
                ...
                <tr>
                  <td className="font-semibold text-[#1A1A1A]">India to Dubai</td>
                ...
                <tr>
                  <td className="font-semibold text-[#1A1A1A]">Philippines to Dubai</td>
                  <td>AED 9,000 – 13,000</td>
                  <td>Permit, vet prep, crate, cargo, customs, delivery</td>
                  <td>No titer test needed. Popular route.</td>
                </tr>
                <tr>
                  <td className="font-semibold text-[#1A1A1A]">Australia to Dubai</td>
                  <td>AED 12,000 – 18,000</td>
                  <td>Permit, vet prep, crate, cargo, customs, delivery</td>
                  <td>No titer test needed. Longer distance = higher cargo cost.</td>
                </tr>
                <tr>
                  <td className="font-semibold text-[#1A1A1A]">High-Risk Countries</td>
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8">
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-4">What's Included in Every PetClear Quote</h3>
              <ul className="space-y-2 text-sm text-[#5C5C5C]">
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" /> MOCCAE import permit application and fees</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" /> Coordination with vetted veterinary partners for health checks and certificates</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" /> IATA-compliant travel crate (or verification of your own)</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" /> Flight booking as manifest cargo with a trusted airline</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" /> Customs clearance at DXB or DWC cargo terminal</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" /> Door-to-door delivery or airport handover in Dubai</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" /> WhatsApp updates at every stage (permit approval, check-in, boarding, arrival, customs clearance)</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#27AE60] shrink-0 mt-0.5" /> Post-arrival guidance for Dubai Municipality registration (Aleef app)</li>
              </ul>
            </div>
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
              <h3 className="text-lg font-semibold text-[#1A1A1A] mb-4">What Costs Extra (And We Tell You Upfront)</h3>
              <ul className="space-y-2 text-sm text-[#5C5C5C]">
              ...
              <div className="mt-6 p-4 bg-[#F5F0E8] rounded-xl">
                <p className="text-sm text-[#5C5C5C] leading-relaxed">
                  <strong className="text-[#1A1A1A]">Why costs vary:</strong> The biggest variables are your origin country (cargo distance), your cat's weight and crate size, and whether a titer test is required. A small cat from India costs less than a large Maine Coon from Australia. We give you an exact quote — not a guess — after our first WhatsApp conversation.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            <div className="bg-[#FAFBF7] rounded-2xl shadow-sm p-6 sm:p-8">
              <div className="flex gap-1 mb-4">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-4 h-4 text-[#E8A838] fill-current" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.26.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.55-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                ))}
              </div>
              <blockquote className="text-[#1A1A1A] text-base leading-relaxed mb-6">
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-[#1A5F4A]/10 flex items-center justify-center text-[#1A5F4A] font-bold text-sm">SM</div>
                <div>
                  <p className="text-sm font-semibold text-[#1A1A1A]">Sarah M.</p>
            ...
            <div className="bg-[#FAFBF7] rounded-2xl shadow-sm p-6 sm:p-8">
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-[#E8A838]/10 flex items-center justify-center text-[#E8A838] font-bold text-sm">PK</div>
                <div>
                  <p className="text-sm font-semibold text-[#1A1A1A]">Priya K.</p>
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#1A5F4A] rounded-3xl p-8 sm:p-12 lg:p-16 text-center">
            ...
            <a
              href="https://wa.me/9715XXXXXXXX?text=Hi%2C%20I%20want%20to%20relocate%20my%20cat%20to%20Dubai.%20Can%20you%20help%20me%20understand%20the%20process%20and%20cost%3F"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-4 bg-[#25D366] text-white rounded-xl font-semibold text-base hover:bg-[#1ebe57] transition-colors shadow-lg"
            >
              <MessageCircle className="w-5 h-5" />
              WhatsApp us about your cat
            </a>
