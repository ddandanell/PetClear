    ...
    <footer className="bg-[#1B2B4D] text-white">
      <div className="max-w-[1200px] mx-auto px-5 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            ...
            <div className="flex items-center gap-3 mt-4">
              <a href="https://www.instagram.com/petclear" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/petclear" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors" aria-label="Facebook">
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <a
            href={getWhatsAppUrl('Hi, I have a question about pet relocation to Dubai.')}
            target="_blank"
