              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4 bg-[#FDFBF8] rounded-2xl p-5">
                  ...
                  <div>
                    ...
                    <p className="text-[#5A5A5A] text-sm">Applied for online via the MOCCAE portal. Valid for 30 days from issue. Must be obtained before booking the flight. Cost: AED 500 per pet.</p>
                  </div>
                </div>
            ...
            <div className="bg-[#FDFBF8] rounded-[20px] p-6 lg:p-8">
              ...
              <div className="mt-6 p-4 bg-[#5A8F6E]/10 rounded-xl">
                <p className="text-sm text-[#2A2A2A] font-medium">
                  <span className="text-[#5A8F6E]">Pro tip:</span> Book your import permit at least 2 weeks before your intended travel date. MOCCAE processing can take 3–5 business days, but delays happen during peak seasons (July–August and December–January).
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-[20px] shadow-sm p-6 lg:p-8">
              ...
              <ul className="space-y-2 text-sm text-[#5A5A5A]">
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#5A8F6E] shrink-0 mt-0.5" /> Multiple daily direct flights LHR → DXB</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#5A8F6E] shrink-0 mt-0.5" /> Emirates SkyCargo Live — dedicated animal services</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#5A8F6E] shrink-0 mt-0.5" /> Priority offloading and fast-track customs at DXB</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#5A8F6E] shrink-0 mt-0.5" /> Large breed capacity available (A380 cargo hold)</li>
              </ul>
