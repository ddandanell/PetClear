  ...
  return (
    <div className="bg-[#FDFBF8]">
      <SEOHead
        ...
        schemas={schemas}
      />
      <Breadcrumb items={[{ label: 'Home', path: '/' }, { label: 'Routes', path: '/routes/' }, { label: 'New Zealand to Dubai' }]} />
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              <div className="relative rounded-[20px] overflow-hidden shadow-md">
                <img src="/images/hero-new-zealand.jpg" alt="Pet relocation from New Zealand to Dubai" className="w-full h-64 sm:h-80 lg:h-96 object-cover" loading="eager" />
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center text-white px-6">
                    ...
                    <p className="text-lg font-semibold">Low-Risk, Strict Biosecurity</p>
                    <p className="text-sm opacity-80">MPI export required — no titer test</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-[20px] shadow-sm p-6 text-center">
              ...
              <p className="text-[#5A8F6E] text-xs mt-2 font-medium">Completely rabies-free</p>
            </div>
            <div className="bg-white rounded-[20px] shadow-sm p-6 text-center">
              <div className="w-14 h-14 bg-[#5A8F6E]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
              ...
              <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-[#EBEBEB]">
                  ...
                  <tr className="bg-[#5A8F6E]/5">
                    ...
                    <td className="px-6 py-4 text-sm font-bold text-[#5A8F6E]">AED 16,000–24,000</td>
                    <td className="px-6 py-4 text-sm font-bold text-[#5A8F6E]">AED 21,000–32,000</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-[20px] shadow-sm p-6 lg:p-8">
              ...
              <ul className="space-y-2 text-sm text-[#5A5A5A]">
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#5A8F6E] shrink-0 mt-0.5" /> Cargo from AKL, WLG, CHC</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#5A8F6E] shrink-0 mt-0.5" /> 17–20 hours with connections</li>
            ...
            <div className="bg-white rounded-[20px] shadow-sm p-6 lg:p-8">
              ...
              <ul className="space-y-2 text-sm text-[#5A5A5A]">
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#5A8F6E] shrink-0 mt-0.5" /> Cargo from Auckland (AKL)</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#5A8F6E] shrink-0 mt-0.5" /> 17–20 hours with connection</li>
                <li className="flex items-start gap-2"><CheckCircle className="w-4 h-4 text-[#5A8F6E] shrink-0 mt-0.5" /> Priority animal handling at all ports</li>
