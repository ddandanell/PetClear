...
const burDubai: AreaPageData = {
  slug: 'bur-dubai',
  areaName: 'Bur Dubai',
  emirate: 'Dubai',
  seoTitle: 'Pet Relocation Bur Dubai | Dog & Cat Transport',
  metaDescription:
    'Pet relocation in Bur Dubai — door-to-door dog and cat transport, MOCCAE permit guidance and IATA travel crates. Get a free WhatsApp quote in 15 minutes.',
  keywords:
  ...
  vetsNote:
    'Bur Dubai and the surrounding creek-side districts are well served by veterinary clinics for the microchip, vaccination and health-certificate steps your pet needs before travel. We coordinate timing with your vet so every document is valid on travel day — and if you prefer, we can recommend a vetted clinic nearby.',
  intro:
    'Bur Dubai is the historic heart of the city — the old creek-side quarter where Dubai grew up, packed with low-rise heritage lanes around Al Fahidi and dense apartment blocks running back from the water. It is home to a tight mix of long-term residents who have lived here for decades and newer expats drawn by the central location and the character of the place. With families moving in from abroad and others heading home or onward, it is one of the areas we relocate pets to and from regularly. Whether you are arriving into a Bur Dubai apartment from overseas or leaving the UAE for a new posting, we handle the permits, paperwork and transport so you can focus on the rest of your move.',
  sections: [
    {
      h2: 'Pet Relocation Services for Bur Dubai Residents',
      body: [
        {
          type: 'list',
          items: [
            'Door-to-door pickup from your Bur Dubai apartment or building',
    ...
    {
      h2: 'Moving To or From Bur Dubai With a Pet',
      body: [
        {
          type: 'p',
    ...
    {
      h2: 'Pet-Friendly Living in Bur Dubai',
      body: [
        {
          type: 'p',
          text: 'Bur Dubai is dense, apartment-style living, so most pets here are dogs and cats kept indoors in compact flats. The waterfront walkways around Al Seef and the creek give residents a pleasant route for daily dog walks, and the older lanes of Al Fahidi are quiet and shaded — though building pet policies vary, so check your tenancy terms before you move in. For apartment pets that are not used to a travel crate, we can advise on crate acclimation in the weeks before travel day so the journey is as calm as possible.',
        },
      ],
    },
    {
      h2: 'Cost of Pet Relocation in Bur Dubai',
      body: [
        {
          type: 'p',
  ...
  faq: [
    {
      q: 'Do you pick up from my building in Bur Dubai?',
      a: 'Yes — we arrange door-to-door pickup from your Bur Dubai apartment or building and coordinate the entire move from there.',
    },
    {
      q: 'How long does pet relocation from Bur Dubai take?',
    ...
    },
    {
      ...
      a: 'We focus on the relocation itself, but we can advise on crate acclimation and travel-day logistics for apartment pets in dense buildings like those across Bur Dubai.',
    },
  ],
  relatedAreas: [
