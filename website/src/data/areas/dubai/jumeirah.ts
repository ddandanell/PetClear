...
const jumeirah: AreaPageData = {
  ...
  whatsappMessage:
    'Hi Dubai Pet Relocation! I live in Jumeirah and need help relocating my pet. Can you guide me on the process and cost?',
  geo: { lat: '25.2048', lng: '55.2603' },
  landmarks: [
    'Jumeirah Beach',
    'Burj Al Arab',
    'Madinat Jumeirah',
